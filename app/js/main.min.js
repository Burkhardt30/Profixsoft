...
!function(){const c=new Swiper(".services__swiper",{slidesPerView:1,spaceBetween:25,navigation:{prevEl:".services__prev",nextEl:".services__next"},breakpoints:{700:{slidesPerView:2},1100:{slidesPerView:3},1400:{slidesPerView:4}}});function e(){const e=document.querySelector(".header__top");10<window.pageYOffset?e.classList.add("header__top--follow"):e.classList.remove("header__top--follow")}function t(){10<window.pageYOffset&&!o.closest(".header__menu--show")?s.classList.add("burger--follow"):s.classList.remove("burger--follow")}c.onAny(function(){var e=document.querySelectorAll(".services__slide"),t=document.querySelector(".services .swiper-slide-active");for(var s of e){const l=s.closest(".services__slide--active");l&&l.classList.remove("services__slide--active")}let o=t;for(let e=0;e<c.params.slidesPerView;e++){if(!o)return;o.classList.add("services__slide--active"),o=o.nextElementSibling}}),document.addEventListener("click",function(t){const s=t.target.closest(".select__btn");if(s){const o=s.closest(".select").querySelector(".select__dropdown");s.closest(".select").classList.toggle("select--active");let e=s.offsetHeight+5;t=s.offsetWidth/2-o.offsetWidth/2;o.getBoundingClientRect().top>document.documentElement.clientHeight-o.offsetHeight&&(e=-o.offsetHeight-5),o.style.top=e+"px",o.style.left=t+"px"}}),document.addEventListener("click",function(t){const s=t.target.closest("li.select__item");if(s){let e=s.closest(".select");t=s.dataset.selectItem,t=e.querySelector("."+t);top.location=t.value}}),document.addEventListener("scroll",e),document.addEventListener("DOMContentLoaded",e),document.addEventListener("scroll",t),document.addEventListener("DOMContentLoaded",t);const s=document.querySelector(".burger"),o=document.querySelector(".header__menu");s.onclick=e=>{e.preventDefault(),s.classList.toggle("burger--active"),o.classList.toggle("header__menu--show"),10<window.pageYOffset&&s.classList.toggle("burger--follow")},SmoothScroll({animationTime:600,stepSize:75,accelerationDelta:30,accelerationMax:2,keyboardSupport:!0,arrowScroll:50,pulseAlgorithm:!0,pulseScale:4,pulseNormalize:1});var l,r=e=>{const t=e.target.closest("a");t&&(e.preventDefault(),o.closest(".header__menu--show")&&(s.classList.remove("burger--active"),o.classList.remove("header__menu--show")),e=t.getAttribute("href"),e=document.querySelector(e).getBoundingClientRect().top-45+window.pageYOffset,window.scrollTo({top:e,behavior:"smooth"}))};const i=document.querySelector(".header__nav");for(l of document.querySelectorAll(".logo"))l.addEventListener("click",r);i.addEventListener("click",r)}();